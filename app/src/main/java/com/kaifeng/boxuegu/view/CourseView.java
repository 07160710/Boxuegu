...
import com.kaifeng.boxuegu.adapter.AdBannerAdapter;
import com.kaifeng.boxuegu.adapter.CourseAdapter;
...
public class CourseView {
    ...
    private void getCourseData(){
        try {
            InputStream is = mContext.getResources().getAssets().open("moduletitle.xml");
